...
class ModelTrainer:
    ...
    def initiate_model_trainer(self,train_array, test_array):
        try:
            logging.info("spliting our data with independent and dependent features")
            # spliting our data with independent and dependent features
            ...
            logging.info("Paramas intialization")
            params = {
                "Random Forest":{
            ...
            # Starting to compute best model score
